      ...
      view: {
        ...
        error_msg: function() {
          var error_code_map = {
            ...
            2: "连接超时.",
            3: "资源未找到.",
            4: "资源未找到. 查阅 --max-file-not-found 选项.",
            5: "资源未找到. 查阅 --lowest-speed-limit 选项.",
            6: "网络错误.",
            7: "未完成的下载任务.",
            8: "远程服务器不支持断点续传.",
            9: "磁盘空间不足.",
            10: "文件片长度与 .aria2 控制文件不一致. 查阅 --allow-piece-length-change 选项.",
            11: "aria2 已在下载此任务.",
            12: "aria2 已在下载此种子.",
            13: "文件已存在. 查阅 --allow-overwrite 选项.",
            14: "重命名失败. 查阅 --auto-file-renaming 选项.",
            15: "打开已存在文件失败.",
            16: "创建新文件或重置文件失败.",
            17: "磁盘错误.",
            18: "创建目录失败.",
            ...
            23: "重定向过多.",
            24: "HTTP 验证失败.",
            25: "aria2 解析bencoded文件失败(通常是 .torrent 文件).",
            26: ".torrent 文件已损坏或缺失必要信息.",
            27: "磁力链错误.",
            28: "选项错误或参数错误.",
            29: "远程服务器忙或过载,请过一段时间重试.",
            30: "解析 JSON-RPC 失败.",
          };
          return function(text) {
